...
export default function CreatedCampiagns() {
  <>
  <h3 class="w-full flex justify-center flex-row flex-wrap mx-auto">User joined campaigns </h3>
  <section class="w-full flex justify-center flex-row flex-wrap mx-auto">
         ...
         <div class="flex flex-col items-stretch min-h-full pb-4 mb-6 transition-all duration-150 bg-white rounded-lg shadow-lg hover:shadow-2xl">
           ...
           <section class="px-4 py-2 mt-2">
             <div class="flex items-center justify-between">
               ...
               <p class="mt-1 text-xs text-gray-600">9 minutes ago</p>
             </div>
           </section>
         </div>
       </div>
